  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 教学安排
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      >
        <el-form ref="form" :model="form" label-width="70px">
          ...
          <el-form-item label="正文">
            <quill-editor ref="myTextEditor" v-model="form.text" :options="editorOption"></quill-editor>
          </el-form-item>
        </el-form>
        ...
        <el-form ref="form" :model="form2" label-width="70px">
          ...
          <el-form-item label="大纲链接">
            ...
            ><i class="el-icon-upload"></i>
              ...
              <div class="el-upload__tip" slot="tip">只能上传大小为150M以内的文件</div></el-upload>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    onChangeQuill(response, file, fileList) {
      ...
      this.form2.link = 'http://121.37.239.127:25555/img/' + response.data;
    },
      ...
      .then(() => {
        ...
        this.$axios.post('/JxdgDelete', {
          ...
          if (res6.data.code === 200) {
            ...
            alert("请截图以下信息报给维护员: 出错位置：jxap.handledelete 出错详情: " + res6.data.msg);
          }
          this.loading = false;
        }).catch(res7 => {
    ...
    saveEdit() {
      ...
      this.$axios.post('/TextAdd', {
        ...
        if (res4.data.code === 200) {
          ...
          alert("请截图以下信息报给维护员: 出错位置：jxap.saveEdit 出错详情: " + res4.data.msg);
        }
        this.loading = false;
      }).catch(res5 => {
