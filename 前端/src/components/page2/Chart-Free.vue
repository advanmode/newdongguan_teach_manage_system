    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 空闲表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
<script>
    export default {
        ...
        methods: {
            getData(){
                this.loading=true;
                this.$axios.get("/FreeTable").then(res1=>{
                    if (res1.data.code===200) {
                        ...
                        alert("请截图以下信息报给维护员: 出错位置：chart-free.getdata 出错详情: " + res1.data.message);
                    }
                    this.loading=false;
                })
            },
